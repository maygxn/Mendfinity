...
class Patient(db.Model, SerializerMixin):
    ...
    # Relationships
    health_journal_entries = db.relationship('HealthJournalEntry', back_populates='patient', cascade="all, delete")
    favorite_exercises = db.relationship('FavoriteExercise', back_populates='patient', cascade="all, delete")
...
class Exercise(db.Model, SerializerMixin):
    ...
    # Relationships
    favorite_exercises = db.relationship('FavoriteExercise', back_populates='exercise', cascade="all, delete")
